...
-(void) _performPostLoadInit
{
	...
	var button=[billingButtonBar addButtonWithImageName:"print.png" target:self action:@selector(printBill:)];
...
-(void) markTravelReimbursed:sender
{
   ...
   // FIXME:  muessen wir das eigentlich als "pseudobuchung auf dem drittmittelkonto noch dokumentieren?
}
